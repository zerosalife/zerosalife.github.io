...
- [[http://zerosalife.github.io/blog/2016/03/19/how-dungeonmans-teaches-diagonal-movement/][How Dungeonmans Teaches Diagonal Movement]]
- [[http://zerosalife.github.io/blog/2016/03/05/proportion-types/][Proportion Types]]
- [[http://zerosalife.github.io/blog/2016/04/23/improvisation-vs-preparation/][Improv vs Preparation]]
  - This could be a conference talk!
- [[http://zerosalife.github.io/blog/2016/06/18/mobile-frame-football-association/][Mobile Frame Football Association]]
  - Needs playtesting
- [[http://zerosalife.github.io/blog/2016/08/27/why-does-pokemon-go-use-passive-voice/][Why Does Pokemon GO Use Passive Voice?]]
- [[http://zerosalife.github.io/blog/2016/11/12/arcana-procedurally-generated-tarot-decks/][Arcana: Procedurally Generated Tarot Decks]]
- [[http://zerosalife.github.io/blog/2016/12/03/procedural-generation-of-social-networks/][Procedural Generation of Social Networks]]

** Procedural generation of social networks
Procedurally generating #procgen social networks for a social rather than spatial hexcrawl campaign
...
monster encounters of the political landscape.  See for, example this
[[http://monstersandmanuals.blogspot.com/2011/08/cyberpunk-sandbox.html][blog post at Monsters and Manuals]] and [[https://en.wikipedia.org/wiki/Barksdale_Organization#/media/File:Barksdale2.jpg][the organization chart from /The
Wire/]].
...
Based on [[http://monstersandmanuals.blogspot.com/2011/08/relationship-hexmap.html][this Monsters and Manuals blog post]] I defined links as
follows:
...
Arcana, random-arcana.herokuapp.com, my #procjam entry based on data from @tinysubversions corpora project.
...
Here's [[https://random-arcana.herokuapp.com/][Arcana]], one of the projects I'm working for #procjam 2016.

Arcana generates a full deck of Tarot cards based on data from [[https://twitter.com/tinysubversions][Darius
Kazemi's]] [[https://github.com/dariusk/corpora][corpora project]].

- Click on the cards to expand each card's meaning.

- Click the button in the corner for a three-card spread from the
  current deck.

- Click the title, Arcana, in the title bar to regenerate a fresh
  deck.

You can check out the entry on the project page here.
...
I'm announcing my participation in [[https://itch.io/jam/procjam][#procjam 2016]], which kicked off
yesterday.  This is my third year participating.  You can look back at
my previous entries from 2014 here: [Insceptahdeckwu]({% post_url
2014-11-08-insceptahdeckwu %}), [Patchwerk]({% post_url
2014-11-15-patchwerk %}) and from 2015 here: [Mech Sheet Generator]({%
post_url 2015-12-05-procjam-2015-restrospective %}).
...
[[https://twitter.com/everyweekadev][Every Week a Dev]] is a twitter bot created by [[https://twitter.com/tha_rami][Rami Ismail]] that
spotlights a new person involved in game development every week.
Check out the archives and follow it if you haven't already.  The
bot's a great aggregator for gamedev wisdom.
...
** Time-based mechanics in turn-based paper prototypes

I had an idea that involves time-based cooldowns.  I was getting
bogged down with implementation details when I simply wanted to try
out some ideas for mechanics that I could later implement.  After
digging for a couple of resources, such as
https://adamsmith.as/papers/Smith_Nelson_Mateas_-_Play_Testing_-_AIIDE09.pdf,
https://learn.canvas.net/courses/3/pages/level-5-dot-5-prototyping-real-time-systems?module_item_id=44550,
and
http://www.gamedev.net/topic/671104-paper-based-prototyping-simulating-real-time/,
I was inclined to simply model a single second in real-time as a turn
in turn-time.

Since I was already thinking about cooldowns in terms of integer
numbers of seconds (for now), it was easy to convert a cooldown of two
seconds to two turns.  I was immediately reminded of examples from
console RPGs like /[[http://vignette3.wikia.nocookie.net/finalfantasy/images/c/ce/FFT_CTB.png/revision/latest?cb%3D20110510000626][Final Fantasy Tactics]]/ and /[[http://gamersonlyolder.com/wp-content/uploads/radianthistoria_screenshots_32.bmp][Radiant Historia]]/ in
which the upcoming turn order is displayed (more or less) and
characters get to act when their turn "pops" off the top of the turn
queue.

I modeled the cooldown by laying out playing cards A-5.  I made a
two-sided card for each ability, one side for the disabled ability
under cooldown and one side for the ready-to-use ability.  I also made
a card for tracking the remaining cooldown time for each ability.

So if an ability has a two turn cooldown (corresponding loosely for
now to 2 seconds in the eventual real-time game), then I place the
cooldown counter on the 2 card.  After each turn, I move the cooldowns
up the playing card tracker, flipping to the active side the
corresponding ability cards for any counters that go off the top.
** Creator Questions
Taking inspiration from [[http://www.decontextualize.com/][Allison Parrish's]] talk: [[http://opentranscripts.org/transcript/programming-forgetting-new-hacker-ethic/][Programming is
Forgetting: Toward a New Hacker Ethic]], here's my version of Parrish's
new hacker ethic for creators.

*** Creator Questions
- Who gets to use what I make?  Who am I leaving out?  How does what I
  make facilitate or hinder access?
- What assets am I using?  Whose labor produced them and what biases
  and assumptions are built in?  What do the assets leave out?
- What systems of authority am I enacting through what I make?  What
  systems of support do I rely on?  How does what I make support other
  people?
- What kind of community am I assuming?  What community do I invite
  through what I make?   How are my personal values reflected in what
  I make?

Watch [[%20out][Allison Parrish's talk]] for more background on why these sorts of
updates are critical for shaping a more welcoming community.
** Zelda BG planning sheet
- design
https://cdn02.nintendo-europe.com/media/downloads/games_8/wiiu_supermariomaker_1/Super_Mario_Bros_sheets.pdf

Width: 240
Height: 224
** ironic vs narrative instructions in games. see ffvi reverse design
** Using d3 for plotting with bl.ocks.org and octopress
*** .block file
YAML configuration customizing the appearance of the Block.  See [[https://bl.ocks.org/-/about][the
...
** Hilbert curves for dungeon generation

http://www.gdcvault.com/play/1021999/Galak-Z-Forever-Building-Space
