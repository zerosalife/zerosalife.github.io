...
underlying motive, so I'll dive right in.
...
Apparently there is so much traffic on #gamedev that any tweet will be
lost in a deluge of announcements and automated bot retweets.  Oh
well, I'll go it alone.
...
artifact that they are creating.  Full disclosure: I should state here
that I'm not smart enough of or trained well enough to think about
these sorts of things.  So I've appealed to an article by Langdon
Winner called /Do Artifacts Have Politics?/, which I will summarize
here.

My thesis is that the things that game designers create carry
