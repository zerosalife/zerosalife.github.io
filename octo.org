...
[[https://twitter.com/tgdfweb/status/624753749521645568]]

[[https://twitter.com/tgdfweb/status/624753990555709440]]
...
won't invent anything new or constructive.  Everything doesn't have to
fit in a tiny box of your arbitrary creation.  There is a place for
lumping thigngs together in useful ways but for the most part this
kind of genre parsing is not constructive.
...
** Using Anonymous LINQ functions or Lambda expressions in Unity C#
...
need to be accessible by the Unity Test Tools in the Editor so we'll
...
The Testing Framework uses an out of date NUnit version of 2.2.10
...
Pro-tip:  Google Docs is great for mock-ups.  Unfortunately Google
Draw doesn't support animation or multiple pages.  Luckily the same
suite of tools is available in Google's PowerPoint app.  If you don't
like the PowerPoint interface, sketch your mock-ups in Draw and copy
them over to PowerPoint.

This way you can rapidly iterate on your mock-ups while keeping a
record.  This approach is in keeping with Aaron Draplin's design
philosophy that space is cheap feel free to experiment and keep
everything because you never know what will influence the final
design.
...
from idiomatic.  Let me state that again, I would not recommend
writing a fresh Clojurescript app this way.  I have chosen to follow
the JavaScript implementation this closely because I want to gain a
better understanding of the Clojurescript/JavaScript interoperation
and also to refine my ability to debug the compiled Clojurescript, so
that I can support idiomatic Clojurescript that much better.
...
I'm following along with [[https://twitter.com/pentadact][@pentadact]]'s tutorial video [[https://youtu.be/I5qxIhdEx28?t%3D1m33s][here]] (You can see
the finished result around 6 minutes into the video).
