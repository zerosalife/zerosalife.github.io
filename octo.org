...
ready to look back on the #procjam talks and the entries to the jam
that caught my eye.  I've been very busy lately working on my own
submissions INSceptahdeckwu and Patchwerk, among other commitments, so
...
- Scale and direction
  ...
  - Top-down (designer first) is easier than bottom-up (player first;
    shout out to @gillianmsmith for this formulation).  Callbacks?
...
- Flow in procedural generation
  ...
  - Static
    ...
    - Metazelda calculates difficulty number for each room from
      desired flow curve.
    - Love @tcoxon 's thoughts on less backtracking.  Algorithmically
...
*** Itch.io
It looks like most of the entries are gathered on a #procjam itch.io
page.  I have no experience with itch.io, but I think setting up an
...
tactics like maximizing cool downs, or usign situational abilities
