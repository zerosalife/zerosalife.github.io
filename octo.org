...
What I'm interested in seeing is a separate /asynchronous/ type of
game, where preparation has its own mechanics that boil down to a solo
game unto itself.  The results of the each player's solo game(s) are
then somehow incorporated and allowed to influence the collaborative
group play session.
...
But other caves are different.  They require diagonal movement to get
the loot.
