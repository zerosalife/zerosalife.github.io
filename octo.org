...
** Logging
When I do tweets from the command line there's some dark majik going
...
deeply underrated, Bangsian fantasy bot, @styx_ebooks.  Using =twurl=
I was able to grant access to the @styx_ebooks app credentials for the
new bot.
** Moving on
...
id Meier's 10 Rules of Game Design
...
I'm thrilled to announce that I'm going to participate in the [[http://itch.io/jam/procjam][upcoming
procedural game jam called #procjam]].  #procjam is a global game jam
and a live-streamed conference in London focused on making things that
make things. You can keep up to date by following the jam tumblr
